...
public class IsAirAt extends MarioCommand implements IMutateable{
	...
	public IsAirAt(GPConfiguration a_conf)
			throws InvalidConfigurationException {
		super(a_conf,2,CommandGene.BooleanClass);
	}

	public IsAirAt() throws InvalidConfigurationException{
	...
	public boolean execute_boolean(ProgramChromosome c, int a_n, Object[] a_args){
		...
		return data.isAir(data.getEgoElementAt(x, y));
	}
