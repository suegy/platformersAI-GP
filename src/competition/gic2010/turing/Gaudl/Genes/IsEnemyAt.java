...
public class IsEnemyAt extends MarioCommand implements IMutateable{
	...
	public IsEnemyAt(GPConfiguration a_conf)
			throws InvalidConfigurationException {
		super(a_conf,2,CommandGene.BooleanClass);
	}

	public IsEnemyAt() throws InvalidConfigurationException{
	...
	public boolean execute_boolean(ProgramChromosome c, int a_n, Object[] a_args){
		...
		return data.isEnemy(data.getEgoElementAt(x, y));
	}
