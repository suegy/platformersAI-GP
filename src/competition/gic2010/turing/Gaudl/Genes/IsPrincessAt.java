...
public class IsPrincessAt extends MarioCommand implements IMutateable{
	...
	public IsPrincessAt(final GPConfiguration a_conf)
			throws InvalidConfigurationException {
		super(a_conf, 2 ,CommandGene.BooleanClass);
	}

	public IsPrincessAt() throws InvalidConfigurationException{
	...
	public boolean execute_boolean(ProgramChromosome c, int a_n, Object[] a_args){
		...
		return data.isPrincess(data.getEgoElementAt(x, y));
	}
