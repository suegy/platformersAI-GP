...
/**
 * A modified version of the BranchTypingCross from Klaus Meffert adjusted to work with BPGP (1,1) evolution
 * @author swen
 *
 */
public class BPGPCrossOverOperator  extends CrossMethod implements Serializable, Comparable<Object>, Cloneable{


	/**
	 * 
	 */
	private static final long serialVersionUID = 7681782135738530444L;
	 ...
	 */
	public BPGPCrossOverOperator(GPConfiguration a_config) {
		this(a_config, false);
	}
	...
	public int compareTo(Object a_other) {
		BPGPCrossOverOperator other = (BPGPCrossOverOperator) a_other;
		if (other == null) {
			return 1;
		}
		return 0;
	 ...
	 */
	public Object clone() {
		BPGPCrossOverOperator result = new BPGPCrossOverOperator(getConfiguration());
		return result;
	}
}
